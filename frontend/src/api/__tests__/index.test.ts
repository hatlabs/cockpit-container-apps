...
describe("API Wrapper", () => {
  ...
  describe("listCategories", () => {
    ...
    it("should call with store filter", async () => {
      const mockCategories = [{ id: "navigation", label: "Navigation", icon: null, description: null, count: 5 }];
  ...
  describe("listPackagesByCategory", () => {
    it("should call with category ID", async () => {
      const mockPackages = [
        { name: "signalk", version: "1.0.0", summary: "Signal K Server", section: "marine", installed: false, upgradable: false },
      ];
